...
components.fontRedHatDisplay = {
	selector: 'html',
	styles: 'https://fonts.googleapis.com/css?family=Red+Hat+Display:400,500,700,900&display=swap'
};

components.fontKalam = {
	selector: 'html',
	styles: 'https://fonts.googleapis.com/css?family=Kalam&display=swap'
};

components.btn = {
	selector: '.btn',
	styles: './components/btn/btn.css'
};
